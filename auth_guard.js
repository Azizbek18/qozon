(function() {
    ...
    function redirectToLogin() {
        ...
        if (path.includes('menu.html') || path.includes('daromad.html') || path.includes('oshpazlaronboard.html') || path.includes('xurmoopa%202') || path.includes('xurmoopa 2') || path.includes('xurmoopa.html') || path.includes('profil.html') || path.includes('chefdashboard.html') || path.includes('chat.html') || path.includes('bildirishnoma.html')) {
            role = 'oshpaz';
        }
